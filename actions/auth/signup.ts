...
import { ISignUpData } from "@/node_modules/oneentry/dist/auth-provider/authProvidersInterfaces";
  ...
  try {
    ...
    const data: ISignUpData = {
      ...
      notificationData: {
        ...
        phonePush: ["+1234567890"], // Phone number

        phoneSMS: "+1234567890", // Phone number
      },
    };
